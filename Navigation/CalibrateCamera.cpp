...
int main(int argc, char **argv) {
  ...
  cv::glob("/home/linux/Pictures/Webcam/Realsense/2023-05-24*.jpg", fileNames, false);
  cv::Size patternSize(8 - 1, 6 - 1);
  std::vector<std::vector<cv::Point2f>> q(fileNames.size());

  std::vector<std::vector<cv::Point3f>> Q;
  // 1. Generate checkerboard (world) coordinates Q. The board has 8 x 6
  // fields with a size of 33x33mm
